...
class MedicineModel {
  ...
  static List<MedicineModel> mockList() => [
    const MedicineModel(id: 'm1', name: 'Paracetamol 500mg', genericName: 'Acetaminophen',
      price: 25.0, storeName: 'Jan Aushadhi Kendra', distance: '1.2 km', hasGeneric: true, manufacturer: 'Cipla'),
    const MedicineModel(id: 'm2', name: 'Amoxicillin 250mg', genericName: 'Amoxicillin',
      price: 85.0, storeName: 'Village Medical Store', distance: '0.5 km', manufacturer: 'Sun Pharma'),
    const MedicineModel(id: 'm3', name: 'Cetirizine 10mg', genericName: 'Cetirizine HCl',
      price: 15.0, storeName: 'Jan Aushadhi Kendra', distance: '1.2 km', hasGeneric: true, manufacturer: 'Dr. Reddy\'s'),
    const MedicineModel(id: 'm4', name: 'Metformin 500mg', genericName: 'Metformin HCl',
      price: 45.0, storeName: 'PHC Pharmacy', distance: '3.0 km', hasGeneric: true, manufacturer: 'USV'),
    const MedicineModel(id: 'm5', name: 'ORS Sachets', genericName: 'Oral Rehydration Salts',
      price: 12.0, isAvailable: false, storeName: 'Village Medical Store', distance: '0.5 km'),
  ];
}
